...
- Any use of AI tools to assist with code or documentation is disclosed in the opening PR comment, including the specific tool and version. See the [AI Policy](inst/AI_POLICY.md) for the full requirements.
