...
For comprehensive examples and tutorials, see our interactive R
notebook:
...
For more detailed examples and use cases, please refer to the [Example
Notebook](example-notebook.md).
