...
mycolumns = data[, c("social")]
table = acro_table(index=index, columns=mycolumns, deparse.level=1)
table
```


### ACRO crosstab multiple dimensions
...
table = acro_crosstab(index=myrows, columns=mycols,deparse.level=1)
