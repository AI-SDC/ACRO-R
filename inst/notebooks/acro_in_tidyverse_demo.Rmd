...
-   *select()* is used to keep only specific column
...
You can see that the output is not just the summary table but also the risk analysis produced by acro. You can then decide what are the steps you are going to make to remove the disclosive cells as discussed in the [acro_demo_2026.Rmd file](acro_demo_2026.Rmd) document.
