...
- [`acro_add_comments()`](acro_add_comments.md) : Add comments to
  outputs
- [`acro_add_exception()`](acro_add_exception.md) : Adds an exception
  request to an output.
- [`acro_crosstab()`](acro_crosstab.md) : Compute a simple cross
...
- [`acro_disable_rounding()`](acro_disable_rounding.md) : Turns rounding
  off during a session
- [`acro_disable_suppression()`](acro_disable_suppression.md) : Turns
  suppression off during a session
- [`acro_enable_rounding()`](acro_enable_rounding.md) : Turns rounding
  on during a session
...
- [`acro_hist()`](acro_hist.md) : Histogram
- [`acro_init()`](acro_init.md) : Initialise an ACRO object
- [`acro_lm()`](acro_lm.md) : Fits Ordinary Least Squares Regression
- [`acro_pie()`](acro_pie.md) : Pie chart
- [`acro_pivot_table()`](acro_pivot_table.md) : Pivot table
- [`acro_print_outputs()`](acro_print_outputs.md) : Prints the current
  results dictionary.
...
- [`acro_table()`](acro_table.md) : Compute a simple cross tabulation of
  two (or more) factors.
- [`create_factors()`](create_factors.md) : Convert data to factors and
  manage NA levels
- [`is_excluded()`](is_excluded.md) : Identify values to be excluded
  from an object
- [`is_invalid()`](is_invalid.md) : Identify empty values; NA or NaN in
  an object
- [`lung`](lung.md) : Lung Cancer Survival Data
- [`nursery_data`](nursery_data.md) : Nursery Database
- [`to_pandas_categorical()`](to_pandas_categorical.md) : Convert an R
  factor to a Pandas Categorical
